        ...
        try {
            ...
            if (userEmail != null && authentication == null) {
                ...
                if (jwtService.isTokenValid(jwt, userDetails)) {
                    Optional<Token> token = tokenRepository.findByValueAndDeleted(jwt, false);
